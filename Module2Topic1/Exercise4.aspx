...
<body>
    ...
    <form runat="server">
        ...
        <asp:RequiredFieldValidator runat="server" ControlToValidate="fullName" ErrorMessage="Full Name is required." ForeColor="Red" /><br />
        ...
        <asp:RangeValidator runat="server" ControlToValidate="age" MinimumValue="0" MaximumValue="100" ErrorMessage="Age must be between 0 and 100." Type="Integer" Display="Dynamic" ForeColor="Red" /><br />
        ...
        <asp:CompareValidator runat="server" ControlToValidate="confirmEmail" ControlToCompare="email" ErrorMessage="Emails don't match." ForeColor="Red" Operator="Equal" /> <br />
